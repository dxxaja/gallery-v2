...
<section class="py-5 text-center container">
    <div class="row py-lg-5 shad">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light" style="color: #98ABEE">{{$album->name}}</h1>
            <p class="lead text-muted" style="color: #98ABEE">{{$album->description}}</p>
            <p>
            ...
            <div class="card" style="background-color: #F9E8C9">
                ...
                <div class="list-group list-group-flush">
                    @foreach ($photo->photoComments as $comment)
                        <div class="list-group-item" style="background-color: #F9E8C9">
